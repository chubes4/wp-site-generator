...
const controller = {
	...
	workflows: [
		...
		},
		{
			...
			publish_gate: {
				...
				requires: ['publish_allowed', 'gates.fallback_blocks.passed', 'gates.block_quality.passed', 'gates.conversion_findings.passed', 'gates.visual_parity.passed'],
				passing_value: true,
			},
		},
		{
	...
	gates: [
		...
		{ gate_id: 'block_quality', description: 'SSI import validation must pass with no core/html, core/freeform, or invalid generated blocks.', metrics: ['block_quality'] },
	...
	metrics: [
		...
		{
			metric_id: 'block_quality',
			description: 'Core HTML, freeform, invalid block counts, and import validation status reported by SSI import validation.',
			target: 'import validation passes and values are 0',
			input: { paths: ['import_validation_result.status', 'import_validation_result.passed', 'import_validation_result.metrics.ssi_core_html_count', 'import_validation_result.metrics.ssi_freeform_block_count', 'import_validation_result.metrics.ssi_invalid_block_count'] },
		},
		{

...
import { appendGithubOutput, parseArgs, runtimeToolProfileInputs, runtimeToolProfiles } from './lib/ci-runtime-utils.mjs';
...
const outputs = {
	...
	runtime_profiles: process.env.HOMEBOY_AGENT_RUNTIME_PROFILES || '',

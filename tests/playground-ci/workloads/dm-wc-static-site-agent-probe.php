...
if (!function_exists('wc_site_generator_static_site_agent_result')) {
    function wc_site_generator_static_site_agent_result(array $metrics, array $metadata, ?string $error = null): array {
        if ($error !== null) {
...
if (!function_exists('wc_site_generator_static_site_agent_inputs')) {
    function wc_site_generator_static_site_agent_inputs(): array {
        return [
...
if (!function_exists('wc_site_generator_static_site_agent_validate_inputs')) {
    function wc_site_generator_static_site_agent_validate_inputs(array $inputs, array $metadata): ?array {
        if ($inputs['github_token'] === '' || $inputs['openai_api_key'] === '') {
            return wc_site_generator_static_site_agent_result([
...
if (!function_exists('wc_site_generator_static_site_agent_configure_settings')) {
    function wc_site_generator_static_site_agent_configure_settings(array $inputs): array {
...
if (!function_exists('wc_site_generator_static_site_agent_bootstrap_abilities')) {
    function wc_site_generator_static_site_agent_bootstrap_abilities(): ?array {
...
if (!function_exists('wc_site_generator_static_site_agent_validate_dependencies')) {
    function wc_site_generator_static_site_agent_validate_dependencies(array $metadata): ?array {
...
if (!function_exists('wc_site_generator_static_site_agent_bundle_metadata')) {
    function wc_site_generator_static_site_agent_bundle_metadata(): array {
...
if (!function_exists('wc_site_generator_static_site_agent_import_bundle')) {
    function wc_site_generator_static_site_agent_import_bundle(string $bundle_path, array &$metadata): array {
...
if (!function_exists('wc_site_generator_static_site_agent_resolve_imported_flow')) {
    function wc_site_generator_static_site_agent_resolve_imported_flow(Agents $agents, Pipelines $pipelines, Flows $flows, array $settings, string $openai_model, array $metadata): array {
        $agent = $agents->get_by_slug('wc-static-site-agent');
        if (!$agent) {
            return wc_site_generator_static_site_agent_result([
                'import_succeeded' => 1,
                'agent_resolved' => 0,
            ], $metadata, 'Imported agent wc-static-site-agent was not found');
        }
...
if (!function_exists('wc_site_generator_static_site_agent_configure_flow')) {
    function wc_site_generator_static_site_agent_configure_flow(Flows $flows, int $agent_id, array $flow, array $inputs): int {
...
if (!function_exists('wc_site_generator_static_site_agent_run_flow')) {
    function wc_site_generator_static_site_agent_run_flow(int $flow_id, array &$metadata): array {
        $start_ns = hrtime(true);
...
if (!function_exists('wc_site_generator_static_site_agent_drain_job')) {
    function wc_site_generator_static_site_agent_drain_job(int $job_id, array &$metadata): array {
        $start_ns = hrtime(true);
...
$bootstrap_error = wc_site_generator_static_site_agent_bootstrap_abilities();
if ($bootstrap_error !== null) {
    return $bootstrap_error;
}

$inputs = wc_site_generator_static_site_agent_inputs();
...
$input_error = wc_site_generator_static_site_agent_validate_inputs($inputs, $metadata);
if ($input_error !== null) {
    return $input_error;
}

$settings = wc_site_generator_static_site_agent_configure_settings($inputs);

$dependency_error = wc_site_generator_static_site_agent_validate_dependencies($metadata);
if ($dependency_error !== null) {
    return $dependency_error;
}

$bundle_metadata = wc_site_generator_static_site_agent_bundle_metadata();
...
$import = wc_site_generator_static_site_agent_import_bundle($metadata['bundle_path'], $metadata);
...
$resolved = wc_site_generator_static_site_agent_resolve_imported_flow($agents, $pipelines, $flows, $settings, $inputs['openai_model'], $metadata);
if (!isset($resolved['flow'])) {
    return $resolved;
}

$agent_id = (int) $resolved['agent_id'];
$flow_id = wc_site_generator_static_site_agent_configure_flow($flows, $agent_id, $resolved['flow'], $inputs);

$run = wc_site_generator_static_site_agent_run_flow($flow_id, $metadata);
...
$drain = wc_site_generator_static_site_agent_drain_job($job_id, $metadata);

...
assert.deepEqual(settingsPayload.workloads[0].artifacts.import_report, { path: 'wp-content/themes/issue-123-native-loop/import-report.json', kind: 'json' }, 'import report artifact declaration matches WP Codebox bench result schema');
assert.deepEqual(

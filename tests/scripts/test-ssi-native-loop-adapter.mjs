...
assert.equal(controller.workflows.find((workflow) => workflow.workflow_id === 'static-validation').execution.kind, 'command', 'static validation runs as deterministic Homeboy command execution');

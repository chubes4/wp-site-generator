...
try {
	...
	assert.equal(payload.website_artifact.schema, 'block-artifact-compiler/website-artifact/v1', 'validator converts candidate files to the SSI website artifact payload schema');
	...
	assert.equal(materializedPayload.website_artifact.schema, 'block-artifact-compiler/website-artifact/v1', 'materialized directory is converted to the SSI website artifact payload schema');
